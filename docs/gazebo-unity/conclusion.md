...
Complete the [Gazebo/Unity Lab Exercises](./lab-exercises/lab1.md) and [Advanced Perception Lab](./lab-exercises/lab2.md) to apply your knowledge to practical scenarios.

## Assessment

Take the [Gazebo/Unity Assessment](./assessments/quiz1.md) and [Multi-Platform Simulation Assignment](./assessments/assignment1.md) to test your understanding of simulation concepts.

## Navigation

[← Previous: Week 6: Unity Integration](./week6.md) | [Next: Course Introduction](../intro.md) | [Module Home](./intro.md)
